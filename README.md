...
Code    |      Description      |      Author      |      |
|:----------|:-------------|:-------------|------:|
| [Towards self-supervised image understanding with SimCLR](https://app.wandb.ai/sayakpaul/simclr/reports/Towards-self-supervised-image-understanding-with-SimCLR--VmlldzoxMDI5NDM)  | An exploration of the SimCLR framework (https://arxiv.org/pdf/2002.05709.pdf) by Chen et al, in which the authors present an effective framework for training vision models in a self-supervised way. | [Sayak Paul](https://app.wandb.ai/sayakpaul) |[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)]
Code    |      Description      |      Author      |      |
|:----------|:-------------|:-------------|------:|
